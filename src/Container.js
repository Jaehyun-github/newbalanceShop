        ...
        <section className="row1">
          <a href="#">
            <Swiper modules={[EffectFade]} effect="fade" className="banner" spaceBetween={0} slidesPerView={1} navigation pagination={{ clickable: true }} 
                ...
                <SwiperSlide><img src={process.env.PUBLIC_URL + banner1} alt="banner1"/></SwiperSlide>
                <SwiperSlide><img src={process.env.PUBLIC_URL + banner2} alt="banner2"/></SwiperSlide>
                <SwiperSlide><video muted autoPlay loop src={process.env.PUBLIC_URL + video} type="video/mp4"></video></SwiperSlide>   
            </Swiper>
          </a>
        </section>
